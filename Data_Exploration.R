...
# PATH_TO_DATA = '~/Dropbox/MSAn Capstone - Spring 2018/Data/3. 100K Sampled Data/final2_sampled100/data/FINAL2_SAMPLED100.csv'
#PATH_TO_DATA = '~/Dropbox/MSAn Capstone - Spring 2018/Data/3. 100K Sampled Data/final2_sampled100.sas7bdat'
#PATH_TO_DATA = '~/Dropbox/MSAn Capstone - Spring 2018/Data/3. 100K Sampled Data/FINAL2_SAMPLED100.XLSX'

PATH_TO_DATA = '/Users/robertward/Dropbox/MSAn Capstone - Fall 2018/Data/3. 100K Sampled Data/FINAL2_SAMPLED100.csv'
...
packages <- c("shiny", "ggplot2", "dplyr", "haven", "DT", "scales", "openxlsx", "Hmisc", "tools", "stargazer", 
              "knitr", "gridExtra")
...
process_data <- function(file, output_var_name) {
...
if (!"RESP" %in% names(data)){
  data <- process_data(PATH_TO_DATA, df)
}
...
table_data <- function(data, output_variable, input_variable, bin_number) {
  ...
  if ((variable_type %in% c("numeric", "integer") )&(unique>20)) {
...
server <- function(input, output) {
  ...
  output$table <- renderDataTable({
    ...
    if (any(data_table$min != "NA")) {
      data_table$min <- round(data_table$min, 1)
      data_table$mean <- round(data_table$mean, 1)
      data_table$max <- round(data_table$max, 1)
